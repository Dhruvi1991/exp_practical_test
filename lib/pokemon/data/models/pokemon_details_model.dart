...
import '../../domain/entities/pokemon_stat_attributes.dart';
...
extension PokemonDetailsModelExtension on PokemonDetailsModel {
  PokemonDetails get toPokemonDetails => PokemonDetails(
      imageUrl: sprites?.other?.officialArtwork?.frontDefault,
      attributesList: stats
          ?.map((e) =>
              PokemonStatAttributes(name: e.stat?.name, baseStat: e.baseStat))
          .toList());
}
